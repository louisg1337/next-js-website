            ...
            <div className="aboutContainer">
                <div className="bioContainer">
                    <motion.div initial={{opacity: 0}} whileInView={{opacity: 1}} viewport={{once: true}} transition={{ duration: 1 }}>
                        ...
                        <p>
                            When I'm not building or creating you can find me either in the gym or in nature. I have a passion for exercising,
                            whether it is out on a hike or in the gym going for a new PR, you can count me in!
                        </p>
                    </motion.div>
                </div>
